...
// .verify/stub2-1783962993967/chart.js
var require_chart = __commonJS({
  ".verify/stub2-1783962993967/chart.js"(exports2, module2) {
...
var import_meta, HOSTED_BACKEND_URL, RAW_BACKEND_URL, ZENIN_API_BASE_URL;
var init_apiConfig = __esm({
  "src/constants/apiConfig.js"() {
    import_meta = {};
    HOSTED_BACKEND_URL = "https://zenin-mx6w.onrender.com/api";
    RAW_BACKEND_URL = import_meta.env.VITE_API_URL || resolveDefaultBackendUrl();
