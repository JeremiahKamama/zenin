...
// .verify/stub2-1783959129731/index.js
var init_stub2_1783959129731 = __esm({
  ".verify/stub2-1783959129731/index.js"() {
...
(async () => {
  ...
  const c1 = mount(React5.createElement(
    ctx.IndicatorActionsProvider,
    { value: actions },
    React5.createElement(mod.IndicatorMetricModal, { countryName: "United States", metric, onClose: () => calls.push(["close"]) })
  ));
  ...
  const c2 = mount(React5.createElement(mod.IndicatorMetricModal, { countryName: "X", metric, onClose: () => {
  } }));
  ...
  const c3 = mount(React5.createElement(
    ctx.IndicatorActionsProvider,
    { value: actions },
    React5.createElement(mod.IndicatorMetricModal, { countryName: "United States", metric: metricNoSeries, onClose: () => {
    } })
  ));
