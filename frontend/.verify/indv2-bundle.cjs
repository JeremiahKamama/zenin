...
// .verify/indv2-entry.jsx
var indv2_entry_exports = {};
__export(indv2_entry_exports, {
  run: () => run
});
module.exports = __toCommonJS(indv2_entry_exports);
...
// .verify/lwc-stub.js
var createChart = () => ({ addSeries: () => ({}), timeScale: () => ({}), subscribeCrosshairMove() {
}, remove() {
}, applyOptions() {
} });
var AreaSeries = {};
...
var CrosshairMode = {};
var LineStyle = {};
var createSeriesMarkers = () => ({ setMarkers() {
} });
...
var normalizePriceLines = (priceLine, priceLines) => {
...
var buildReadout = ({ mode, time, point, seriesEntry, valueFormatter, timeFormatter, readoutFormatter }) => {
...
var getLatestReadout = (series, valueFormatter = formatReadoutPrice, timeFormatter = formatReadoutTime, readoutFormatter = null) => {
    ...
    series.forEach(({ name, data, type = "area", color = chartColors.info(), options: seriesSpecificOptions = {} }) => {
      ...
      const addSeries = () => {
        if (type === "area") {
          ...
          return typeof chart.addSeries === "function" ? chart.addSeries(AreaSeries, seriesOptions2) : chart.addAreaSeries?.(seriesOptions2);
        }
        if (type === "candlestick") {
          const seriesOptions2 = {
          ...
          return typeof chart.addSeries === "function" ? chart.addSeries(CandlestickSeries, seriesOptions2) : chart.addCandlestickSeries?.(seriesOptions2);
        }
        if (type === "histogram") {
          const seriesOptions2 = {
            color: resolvedColor,
          ...
          return typeof chart.addSeries === "function" ? chart.addSeries(HistogramSeries, seriesOptions2) : chart.addHistogramSeries?.(seriesOptions2);
        }
        const seriesOptions = {
          color: resolvedColor,
          lineWidth: 2,
        ...
        return typeof chart.addSeries === "function" ? chart.addSeries(LineSeries, seriesOptions) : chart.addLineSeries?.(seriesOptions);
      };
...
var HORIZON_ORDER = ["IMMEDIATE", "SHORT_TERM", "MEDIUM_TERM", "STRUCTURAL"];
...
var NO_TRANSMISSION = "No verified transmission available.";
...
var COMMODITY_GROUP_IDS = Object.keys(COMMODITY_GROUP_DEFS);

// src/utils/deskIntelligence.js
var REGISTRY_GROUPS = COMMODITY_GROUP_ORDER.filter((g) => g !== "all");

// src/utils/assetGraph.js
var COMMODITY_RELATIONS = {
...
var COMPANY_TO_COMMODITIES_EXPLICIT = {
  XOM: ["CL", "WTI", "BRENT", "NG"],
  CVX: ["CL", "WTI", "NG"],
  COP: ["CL", "WTI", "NG"],
  BP: ["BRENT"],
...
var COMPANY_TO_COMMODITIES_DERIVED = (() => {
  const out = {};
...
var BY_CODE = Object.fromEntries(MACRO_INDICATORS.map((i) => [i.code, i]));
...
var toneClass = (direction) => direction === "up" || direction === "positive" ? "up" : direction === "down" || direction === "negative" ? "down" : "flat";
function IndicatorMetricModal({ countryName, metric, onClose }) {
  ...
  const rootNode = (0, import_react3.useMemo)(() => toGraphRoot(metric), [metric]);
  ...
  const openNode = (0, import_react3.useCallback)((nodeName) => {
    try {
      TransmissionEngine.openExplorer({ label: nodeName, name: nodeName }, { source: "IndicatorMetricModal", indicator: metric?.label });
    } catch {
    }
  }, [metric]);
  ...
  const surprise = metric?.surprise != null ? `${metric.surprise >= 0 ? "+" : ""}${fmt(metric.surprise, metric?.unit)}` : metric?.consensus != null && metric?.current != null ? `${metric.current - metric.consensus >= 0 ? "+" : ""}${fmt(metric.current - metric.consensus, metric?.unit)}` : "\u2014";
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "modal-overlay indicator-detail-overlay", onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "modal-content indicator-metric-modal indicator-v2", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("header", { className: "imv2-header", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-header-main", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { className: "imv2-title", children: metric?.label || "Indicator" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-meta-row", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
            ...
            " ",
            metric?.group || metric?.category || "Macro"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
            ...
            " ",
            updatedLabel || metric?.date || "Unknown"
          ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-header-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => openNode(rootNode), title: "Open Macro Workspace / Transmission Explorer", children: "Open Macro Workspace" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-icon-btn", title: "Pin Indicator", children: "Pin" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-icon-btn", title: "Add to Watchlist", children: "+ Watch" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "imv2-hero", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-hero-value", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "imv2-big-number", children: fmt(metric?.current, metric?.unit) }),
        stats ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: `imv2-hero-delta ${stats.current >= stats.first ? "up" : "down"}`, children: [
          ...
          fmt(stats.current - stats.first, metric?.unit),
          " (",
          fmtPct(stats.first !== 0 ? (stats.current - stats.first) / Math.abs(stats.first) * 100 : 0),
          ")"
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "imv2-hero-tag", children: metric?.consensus != null && metric?.current != null ? metric.current >= metric.consensus ? "Above Consensus" : "Below Consensus" : "No consensus available" })
      ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-rail-card", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-read-grid", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: fmt(metric?.current, metric?.unit) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Previous" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: metric?.previous != null ? fmt(metric.previous, metric?.unit) : "\u2014" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Expected" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: metric?.consensus != null ? fmt(metric.consensus, metric?.unit) : metric?.forecast != null ? fmt(metric.forecast, metric?.unit) : "\u2014" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Surprise" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: surprise })
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-rail-card", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-signal", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-signal-row", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: metric?.source || "FRED" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-rail-card", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-signal", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-signal-row", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: metric?.coverage || "Single series" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-signal-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Update cadence" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: metric?.cadence || "Monthly" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-signal-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Missing fields" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: metric?.missing ? metric.missing.join(", ") : "None reported" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-signal-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Last fetch" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: metric?.fetchedAt ? relativeTime(metric.fetchedAt) : updatedLabel || "\u2014" })
            ] })
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "imv2-section", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "imv2-prose", children: metric?.interpretation || macroSignal?.explain || defaultInterpretation(metric) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "imv2-section imv2-two-col", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "imv2-prose", children: metric?.interpretation || currentInterpretation(metric, stats, regime) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "imv2-section", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      ...
      ] }, `${node.name}-${i}`)) }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(GuidedEmptyState, { eyebrow: "No Path", title: "No transmission path mapped.", description: `The ${metric?.label || "indicator"} node has no downstream transmission edges in the current graph. Map a path in the Transmission Registry to populate this view.` })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "imv2-section", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "imv2-section", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-timeline", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-tl-col", children: [
          ...
          metric?.current != null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-tl-row", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: metric.label }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: fmt(metric.current, metric.unit) }),
          ...
          metric?.previous != null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-tl-row", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Previous" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: fmt(metric.previous, metric.unit) }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("em", { children: "\u2014" })
          ] }) : null
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-tl-col", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "Next Scheduled" }),
          metric?.nextRelease ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-tl-row", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: metric.nextRelease.label || "Release" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: metric.nextRelease.date || "\u2014" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("em", { children: metric.nextRelease.countdown || "" })
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "imv2-section", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(DensePanelHeader, { title: "Related Research" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-research-links", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => openNode(rootNode), children: "Open Macro Workspace" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => openNode(countryName || "United States"), children: "Open Country Profile" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", children: "View Decision Ledger" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", children: "View Portfolio Exposure" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => openNode(rootNode), children: "Open Transmission Explorer" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("footer", { className: "imv2-footer", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", children: "Pin" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", children: "Watch" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", children: "Alert" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", children: "Compare" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", children: "Export" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", children: "Copy link" })
    ] })
  ] }) });
}
...
var CPI = {
  ...
  date: "2026-06-01",
  series: Array.from({ length: 120 }, (_, i) => ({ ts: Date.now() - (120 - i) * 30 * 24 * 3600 * 1e3, value: 130 + i * 0.12 + Math.sin(i / 6) * 0.8 }))
};
var EMPTY = { code: "TEST", label: "Test Indicator", group: "activity", source: "FRED", unit: "%", current: 50 };
function run() {
  return {
    withData: (0, import_server.renderToStaticMarkup)(import_react4.default.createElement(IndicatorMetricModal, { countryName: "United States", metric: CPI, onClose() {
    } })),
    noData: (0, import_server.renderToStaticMarkup)(import_react4.default.createElement(IndicatorMetricModal, { countryName: "United States", metric: EMPTY, onClose() {
    } }))
  };
}
