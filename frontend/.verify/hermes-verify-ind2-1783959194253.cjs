...
// .verify/stub2-1783959194253/chart.js
var require_chart = __commonJS({
  ".verify/stub2-1783959194253/chart.js"(exports2, module2) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "modal-overlay indicator-detail-overlay", onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "modal-content indicator-metric-modal indicator-v2", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("header", { className: "imv2-header", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-header-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => handleOpenTransmission(rootNode), title: "Open Macro Workspace / Transmission Explorer", children: "Open Macro Workspace" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "imv2-section", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "imv2-research-links", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => handleOpenTransmission(rootNode), children: "Open Macro Workspace" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => onOpenProfile && onOpenProfile({ symbol: indicatorCode }), children: "Open Country Profile" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => onDecisionLedger && onDecisionLedger({ indicator: indicatorCode }), children: "View Decision Ledger" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => onExposure && onExposure({ indicator: indicatorCode }), children: "View Portfolio Exposure" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-link-btn", onClick: () => handleOpenTransmission(rootNode), children: "Open Transmission Explorer" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("footer", { className: "imv2-footer", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: `imv2-foot-btn ${isPinned ? "active" : ""}`, onClick: () => onPin && onPin({ code: indicatorCode, label: metric2?.label }), disabled: !onPin, children: "Pin" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: `imv2-foot-btn ${isInWatchlist ? "active" : ""}`, onClick: handleToggleWatch, disabled: !onToggleStar, children: "Watch" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", onClick: () => onAlert && onAlert({ code: indicatorCode, label: metric2?.label }), disabled: !onAlert, children: "Alert" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", onClick: () => onCompare && onCompare(indicatorCode), disabled: !onCompare, children: "Compare" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", onClick: () => onExport && onExport({ code: indicatorCode, label: metric2?.label, metric: metric2 }), disabled: !onExport, children: "Export" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "imv2-foot-btn", onClick: () => onCopyLink && onCopyLink({ code: indicatorCode, label: metric2?.label }), disabled: !onCopyLink, children: "Copy link" })
    ] })
  ] }) });
}
...
(async () => {
  ...
  ["Pin", "Watch", "Alert", "Compare", "Export", "Copy link", "Open Macro Workspace", "View Decision Ledger", "View Portfolio Exposure", "Open Transmission Explorer"].forEach((t) => check("present:" + t, buttons.includes(t)));
  const related = c1.querySelectorAll(".imv2-related-card");
  check("relatedIndicators>0", related.length > 0);
  ["Pin", "Watch", "Alert", "Compare", "Export", "Copy link", "Open Macro Workspace", "View Decision Ledger", "View Portfolio Exposure", "Open Transmission Explorer"].forEach((t) => clickByText(c1, t));
  ...
  (0, import_react5.act)(() => {
    related[0].dispatchEvent(new window.MouseEvent("click", { bubbles: true }));
  });
  ...
  const disabledFoot = Array.from(c2.querySelectorAll(".imv2-foot-btn")).filter((b) => b.disabled);
  check("disabledWhenNoActions", disabledFoot.length === 6);
  const c3 = mount(React4.createElement(
    ctx.IndicatorActionsProvider,
    { value: actions },
    React4.createElement(mod.IndicatorMetricModal, { countryName: "United States", metric: metricNoSeries, onClose: () => {
    } })
  ));
  const txt = c3.textContent;
